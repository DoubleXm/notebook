---
title: '目录结构 & 基础命令'
description: 'Linux 目录结构、通配符与 w/who/last 等基础命令'
---
...
![alt text](/devops/linux/w-command-output.png)
...
![alt text](/devops/linux/who-command-output.png)

### last 查看当前和过去登录用户信息

显示登录的用户名、登录的终端、登录的 IP、登录的时间、退出的时间以及在线时间。

![alt text](/devops/linux/last-command-output.png)

### lastlog 显示所有用户最近一次登录信息

![alt text](/devops/linux/lastlog-command-output.png)
...
![01](/devops/linux/wildcard-match-1.png)
![02](/devops/linux/wildcard-match-2.png)
