---
title: '浏览器中常见的观察者 Observer'
description: 'IntersectionObserver、MutationObserver、ResizeObserver 与 PerformanceObserver'
---
...
![alt text](/frontend-engineering/intersection-observer-demo.png)
