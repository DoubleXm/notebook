---
title: '模块、包'
description: '模块导入、搜索路径、包的构建与相对导入'
---
...
```python tab="package/__init__.py"
...
```python tab="package/sub_package/main.py"
def main():
    print('this is sub_package')
```
```python tab="package/child_package/main.py"
from . import utils
