---
title: 'unittest 原生测试框架'
description: 'unittest 核心概念与接口测试实践'
---
...
![alt text](/backend/python/automation/unittest-api-test.png)
