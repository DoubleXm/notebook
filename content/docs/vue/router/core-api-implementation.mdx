---
title: 'VueRouter 核心 API 实现原理'
description: '路由模式、createRouter、RouterView 渲染与导航守卫的实现原理'
---

![vue-router](/vue/router/vue-router-4-architecture.png)
