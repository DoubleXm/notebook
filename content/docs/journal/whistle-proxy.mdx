---
title: '基于 whistle + SwitchyOmega 的前端代理方案'
description: 'whistle 安装配置与 SwitchyOmega 代理切换'
---
...
![alt text](/journal/whistle-install-1.png)
...
![alt text](/journal/whistle-install-2.png)
...
![alt text](/journal/switchyomega-config.png)
