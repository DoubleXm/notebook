...
description: 'iTerm2 设置、Oh-my-zsh 与 powerlevel10k 主题配置'
---

![08](/journal/final-effect.png)
...
![01](/journal/iterm2-settings-1.png)

透明色，模糊，背景图，默认宽高设置 Settings -> Profiles -> Windows

![02](/journal/iterm2-settings-2.png)

命令行背景色设置 Settings -> Profiles -> Colors

![03](/journal/iterm2-settings-3.png)

状态栏设置 Settings -> Profiles -> Session

![04](/journal/iterm2-settings-4.png)
...
![05](/journal/p10k-config-1.png)

下载完字体，使用 vscode 的同学需要把 vscode 的终端字体与 iterm2 保持一致。

![06](/journal/p10k-config-2.png)
...
![07](/journal/terminal-preview.png)
