---
title: '深入理解 Suspense 和 ErrorBoundary'
description: 'lazy 懒加载、Suspense 兜底与 ErrorBoundary 的错误捕获'
---
...
![alt text](/react/error-boundary-1.png)
...
![alt text](/react/error-boundary-2.png)
...
![alt text](/react/summary-1.png)

从 `ReactFiberThrow.js` 中可以看出是如何处理的错误和 promise 的。

![alt text](/react/summary-2.png)
