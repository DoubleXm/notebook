---
title: 'React for TypeScript'
description: 'JSX、函数组件、事件、ref 转发与 reducer 的类型标注方式'
---

## JSX

![alt text](/react/jsx-typing.png)
...
![alt text](/react/function-component-typing.png)
...
![alt text](/react/css-property-typing.png)
...
![alt text](/react/html-attribute-typing-1.png)
...
![alt text](/react/html-attribute-typing-2.png)
...
![alt text](/react/event-handler-typing.png)
...
![alt text](/react/usereducer-typing.png)
...
![alt text](/react/forwardref-typing.png)
...
![alt text](/react/useimperativehandle-typing.png)
