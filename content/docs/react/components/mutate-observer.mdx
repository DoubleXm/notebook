---
title: 'MutateObserver DOM变更'
description: 'MutationObserver 的 Hook 封装与组件封装'
---
...
![alt text](/react/components/mutate-observer-overview.png)
...
![alt text](/react/components/mutate-observer-hook.png)
...
![alt text](/react/components/mutate-observer-component-1.png)
...
![alt text](/react/components/mutate-observer-component-2.png)
