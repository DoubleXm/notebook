---
title: 'Icon 图标'
description: 'Icon 基础组件与 createIcon 工厂方法'
---
...
![alt text](/react/components/icon-overview.png)
...
![alt text](/react/components/icon-component-1.png)

测试使用方案，在 antd 的 icon 中随便找一个复制其 viewBox 和 path 的内容

![alt text](/react/components/icon-component-2.png)
...
![alt text](/react/components/create-icon.png)
