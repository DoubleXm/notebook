---
title: 'StoryBook 组件库文档'
description: 'StoryBook 基本用法、autodocs、布局背景视口与 ArgTypes 类型标注'
---
...
![alt text](/react/components/storybook-basics-1.png)
...
![alt text](/react/components/storybook-basics-2.png)
...
![alt text](/react/components/storybook-basics-3.png)
...
![alt text](/react/components/storybook-argtypes-1.png)
...
```
![alt text](/react/components/storybook-argtypes-2.png)
...
![alt text](/react/components/storybook-argtypes-table.png)
...
```
![alt text](/react/components/storybook-autodocs.png)
...
![alt text](/react/components/storybook-layout.png)
...
![alt text](/react/components/storybook-backgrounds.png)
...
![alt text](/react/components/storybook-viewport.png)
...
![alt text](/react/components/storybook-test.png)
