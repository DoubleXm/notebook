...
description: '日期选择面板的实例方法、当前日期高亮、受控模式与禁用日期处理'
---
...
![alt text](/react/components/date-picker-panel-overview.png)
...
![alt text](/react/components/date-picker-panel-instance-and-highlight.png)
...
![alt text](/react/components/date-picker-panel-controlled.png)

## 灰色日期的点击

![alt text](/react/components/date-picker-panel-disabled-date-click.png)
