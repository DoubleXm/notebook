---
title: '单元测试'
description: '测试用例与套件、render、renderHook 与命令行用法'
---
...
![alt text](/react/components/test-suite.png)
...
![alt text](/react/components/test-cli-1.png)
...
```
![alt text](/react/components/test-cli-2.png)
...
![alt text](/react/components/test-render.png)
...
![alt text](/react/components/test-render-hook-1.png)
...
![alt text](/react/components/test-render-hook-2.png)

再或者直接测试自定义 hook 也可以。

![alt text](/react/components/test-render-hook-3.png)
